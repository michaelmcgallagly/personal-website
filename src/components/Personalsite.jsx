  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center">
      ...
      <div className="text-left">
        ...
        <p>This website utilises the React.js library and the CSS framework Tailwind to create a sleek web design with interactive features. It is the site you are currently on! </p>
