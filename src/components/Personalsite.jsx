  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center">
      ...
      <div className="text-left">
       ...
       <a href="https://mcgallagly.netlify.app/"> <button className="bg-blue-500 text-white p-2 mt-2 mr-2 rounded hover:bg-blue-700 transition duration-300 ease-in-out">View Site</button>  </a> 

       <a href="https://github.com/michaelmcgallagly/personal-website"> <button className="bg-gray-500 text-white p-2 mt-2 rounded hover:bg-gray-700 transition duration-300 ease-in-out">View Code</button>  </a> 
        </div>
