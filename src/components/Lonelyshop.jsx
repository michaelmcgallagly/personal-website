  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center">
      ...
      <div className="text-left">
        ...
        <p>My first ever full stack website. It utlises HTML, CSS and Javascript. It also uses firebase for the backend to store all the information on each of the products.</p>
