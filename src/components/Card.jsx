...
export default function Card() {
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center">
    ...
    <div className="text-left flex flex-col ">
      ...
      <p>I am about to go into my 3rd year of my MEng degree in Computer Science at The University of Strathclyde. Alongside programming, I have other passions such as going to the gym and skateboarding</p>
    </div>
  </div>
</div>
  )
